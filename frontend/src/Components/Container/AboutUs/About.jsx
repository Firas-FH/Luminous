    ...
    <div className="about pl-[9%] h-screen w-screen">
      <div className="about1 flex justify-center md:flex-nowrap">
        <div className="w-full md:w-1/2 xl:w-1/2 pt-12 md:p-6">
          ...
          <button onClick={handleContactClick} className="bg-headerscolor w-[180px] h-[60px] text-white py-2 px-4 text-lg mt-8 hover:bg-highlightcolor transition">Contact Us Now</button>
        </div>
      ...
      <div className="video flex justify-center pr-[9%] ">
        <video
