...
function Footer() {
    ...
    const handleSubmit = (e) => {
        ...
        const userId = 'ZMs03pDmb_azX7Bl5';
        const serviceId = 'service_2wflc7o';
        const templateId = 'template_ga4wepl';
                          ...
                          <form onSubmit={handleSubmit}>
                              ...
                              <div className="relative mb-6 w-full" data-te-input-wrapper-init>
                                  ...
                                  <label
                                      ...
                                      className="pointer-events-none absolute top-0 left-3 mb-0 max```javascript
                                      -w-[90%] origin-[0_0] truncate pt-[0.37rem] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[0.9rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[te-input-state-active]:-translate-y-[0.9rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-neutral-200 dark:peer-focus:primary"
                                  >
                                      Message
                                  </label>
                              </div>
                              <div className="flex justify-center">
                                  <button
                                      ...
                                      className="w-[180px] bg-headerscolor px-7 pt-2.5 pb-2 text-xs uppercase leading-normal text-white hover:bg-highlightcolor transition duration-150 text-lg mb-0"
                                  >
                                      Send Message
                                  </button>
                              </div>
